...
local Window = OrionLib:MakeWindow({Name = "Rod", HidePremium = false, SaveConfig =true,IntroText="加载脚本", ConfigFolder = "Rod"})
...
Tab:AddParagraph("作者","恐怖对决小枫")
Tab:AddParagraph("Rod脚本中心")
...
local DoorsT = Window:Tab("doors",'1025028992')
