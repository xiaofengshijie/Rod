...
Notify("落叶中心", "作者小枫qwe", "rbxassetid://2676403574", 3)
Notify("永久免费", "祝你使用开心","rbxassetid://1025028992",3)
Notify("永久免费", "没有盈利","rbxassetid://1025028992",3)
Notify("Rod中心", "永久免费","rbxassetid://1025028992",3)
Notify("永不跑路", "拒绝倒卖","rbxassetid://1025028992",3)
Notify("启动完成", "祝你玩的开心","rbxassetid://1025028992",5)

local Library = loadstring(game:HttpGet('https://raw.githubusercontent.com/XiaoYunCN/UWU/main/Library%2FSilent%20ui'))()
local Window = Library:new("Rod中心 ");

local creds = Window:Tab("公告",'2676403574')
local bin = creds:section("信息",true)
local about = creds:section("作者",true)

local Main = Window:Tab("主要",'1025028992')
...
local JSDGt = Window:Tab("驾驶帝国",'1025028992')
local JSDG = JSDGt:section("自动&刷钱",true)

local FMDHt = Window:Tab("伐木大亨2",'1025028992')
local FMDH = FMDHt:section("伐木大亨2",true)

local SKQSt = Window:Tab("鲨口求生2",'1025028992')
...
local LLCQt = Window:Tab("力量传奇",'1025028992')
...
about:Label("作者kr X")
about:Label("作者QQ2676403574")
about:Label("正在努力优化")
about:Label("请勿倒卖")
about:Button("复制作者QQ", 小枫qwe()
    setclipboard("2676403574")
end)
about:Button("复制QQ群", Rod中心()
    setclipboard("1025028992")
end)
